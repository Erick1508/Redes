	...
	if ((args.length == 8) || (args.length == 4)){
	  ...
	  System.exit(0);
        ...
        try {
            ...
            Comandos c = (Comandos)
	    // el servidor nos brinda el ServicioArchivos
	    ...
	    System.out.println("\n");
            ...
            System.out.println(" No se pudo establecer la conexion, puerto no disponible ");
            System.out.println(
                        "RemoteException");
